...
namespace ABCRetailers.Services
{
    public class AzureStorageService : IAzureStorageService
    {
        ...
        public AzureStorageService()
        {
            ...
            var connectionString = "DefaultEndpointsProtocol=https;AccountName=cloud7843;AccountKey=ApaFegxeDq9ayJtyTjA7xWZNw5AAyfODRh+SkIngUsnhcwH49oEg7Ak4enlnTdBao0e7//E7JEVY+AStZlP0dw==;EndpointSuffix=core.windows.net;";

            // Table and container names (you can keep these configurable if you want)
